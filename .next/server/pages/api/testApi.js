...
async function handler(req, res) {
    ...
    if (req.method === 'GET') {
        ...
        await axios__WEBPACK_IMPORTED_MODULE_1___default().get(API.backendHost + '/testApi').then((response)=>{
...
var __webpack_exports__ = __webpack_require__.X(0, [79], () => (__webpack_exec__(2319)));

...
async function handler(req, res) {
    ...
    if (req.method === 'POST') {
        await axios__WEBPACK_IMPORTED_MODULE_1___default().post(API.backendHost + '/validateData', req.body).then((response)=>{
...
var __webpack_exports__ = __webpack_require__.X(0, [79], () => (__webpack_exec__(3651)));
